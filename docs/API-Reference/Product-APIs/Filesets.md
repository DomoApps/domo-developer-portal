...
- `description`: A brief description of the file set.
- `aiEnabled`: Boolean indicating if AI features are enabled.
- `indexStatus`: The current indexing status (null if not applicable).
- `connector`: The connector that powers this file set.
...
- `owner`: User ID of the current owner.
- `accountId`: Account ID associated with the file set.
- `connectorContext`: Contextual information specific to the connector (null if not applicable).
...
```javascript
fetch('https://example.com/api/files/v1/filesets/ea00c33d-2197-4077-8838-d76a26dee417', {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
  },
...
url = 'https://example.com/api/files/v1/filesets/ea00c33d-2197-4077-8838-d76a26dee417'
...
```bash
curl -X GET 'https://example.com/api/files/v1/filesets/ea00c33d-2197-4077-8838-d76a26dee417' \
     -H 'Content-Type: application/json'
```
...
- `indexStatus`: The current index status of the FileSet.
- `connector`: Describes the connector used for the FileSet.
- `created`: The date and time when the FileSet was created.
- `createdBy`: The identifier of the user who created the FileSet.
- `updated`: The date and time when the FileSet was last updated.
- `updatedBy`: The identifier of the user who last updated the FileSet.
- `owner`: The owner of the FileSet.
- `accountId`: The account ID associated with the FileSet.
- `connectorContext`: The context of the connector, if any.
- `permission`: The permission level of the requester on the FileSet.
- `size`: The size of the FileSet.
- `fileCount`: The number of files within the FileSet.
...
const url = 'https://api.example.com/api/files/v1/filesets/233fb094-4564-4ec1-8d92-67d8320661bc';
const options = {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
...
url = 'https://api.example.com/api/files/v1/filesets/233fb094-4564-4ec1-8d92-67d8320661bc'
headers = {
    'Content-Type': 'application/json'
}
payload = {
...
```bash
curl -X POST 'https://api.example.com/api/files/v1/filesets/233fb094-4564-4ec1-8d92-67d8320661bc' \
-H 'Content-Type: application/json' \
-d '{
  "name": "Policies (FY25)",
  "description": "Repository for new policies created ONLY in FY2025"
...
```javascript
// Example using fetch
fetch('https://api.example.com/api/files/v1/filesets/f94c206a-b91e-4c4d-8153-513e4212f8ed', {
  method: 'DELETE',
  headers: {
    'Content-Type': 'application/json'
  }
...
.then(response => {
  if (response.status === 204) {
    ...
    console.error('Error deleting FileSet:', response.statusText);
  }
});
```
...
response = requests.delete(
    'https://api.example.com/api/files/v1/filesets/f94c206a-b91e-4c4d-8153-513e4212f8ed',
...
if response.status_code == 204:
    ...
    print(f'Error deleting FileSet: {response.status_code}')
```
...
```bash
curl -X DELETE 'https://api.example.com/api/files/v1/filesets/f94c206a-b91e-4c4d-8153-513e4212f8ed' \
     -H 'Content-Type: application/json'
```
...
axios.post('/api/files/v1/filesets/7ad2f92f-e5fc-4f8c-b618-46a997095169/query', {
    query: "benefit",
...
url = "/api/files/v1/filesets/7ad2f92f-e5fc-4f8c-b618-46a997095169/query"
headers = {'Content-Type': 'application/json'}
data = {
    "query": "benefit",
    "pathPrefixFilter": "sample/directory/path",
...
```bash
curl -X POST "/api/files/v1/filesets/7ad2f92f-e5fc-4f8c-b618-46a997095169/query" \
-H "Content-Type: application/json" \
-d '{
  "query": "benefit",
  "pathPrefixFilter": "sample/directory/path",
...
fetch('/api/files/v1/filesets/808b20bd-31e7-4fb8-96c2-98bd93e91a4e/ownership', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
url = '/api/files/v1/filesets/808b20bd-31e7-4fb8-96c2-98bd93e91a4e/ownership'
...
curl -X POST '/api/files/v1/filesets/808b20bd-31e7-4fb8-96c2-98bd93e91a4e/ownership' \
-H 'Content-Type: application/json' \
-d '{"userId": 109}'
```
...
- `fileSetAccess`: An array that shows the access permissions for each entity.
  - `entityId`: The ID of the entity with access.
  - `entityType`: The type of entity (e.g., USER).
  - `permission`: The level of permission granted (e.g., OWNER).
...
axios.post('https://api.example.com/api/files/v1/filesets/0615d132-61b4-4643-a146-dfadef183089/files', data, {
  headers: {
    'Content-Type': 'application/json'
  }
})
...
url = "https://api.example.com/api/files/v1/filesets/0615d132-61b4-4643-a146-dfadef183089/files"
headers = {
    "Content-Type": "application/json"
}
data = {
...
```bash
curl -X POST https://api.example.com/api/files/v1/filesets/0615d132-61b4-4643-a146-dfadef183089/files \
-H "Content-Type: application/json" \
...
- `size`: The size of the file in bytes, null for directories.
...
- `fileType`: Indicates whether the created entity is a file or directory (e.g., "DIRECTORY").
...
```javascript
fetch('https://api.example.com/api/files/v1/filesets/c71f4ec4-c3a7-4dd5-8dc2-c1ea14f40a97/files/search', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
...
url = 'https://api.example.com/api/files/v1/filesets/c71f4ec4-c3a7-4dd5-8dc2-c1ea14f40a97/files/search'
headers = {
    'Content-Type': 'application/json'
}
data = {
...
```bash
curl -X POST https://api.example.com/api/files/v1/filesets/c71f4ec4-c3a7-4dd5-8dc2-c1ea14f40a97/files/search \
  -H 'Content-Type: application/json' \
  -d '{
...
```javascript
fetch('https://yourapi.com/api/files/v1/filesets/5d3a209d-973f-43c3-8e3e-a3dba4052aed/files/multipart', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
url = 'https://yourapi.com/api/files/v1/filesets/5d3a209d-973f-43c3-8e3e-a3dba4052aed/files/multipart'
headers = {'Content-Type': 'application/json'}
data = {
    'path': 'example/path/to/resource'
}
...
```bash
curl -X POST 'https://yourapi.com/api/files/v1/filesets/5d3a209d-973f-43c3-8e3e-a3dba4052aed/files/multipart' \
-H 'Content-Type: application/json' \
...
```javascript
const axios = require('axios');
const fileData = new Blob(['(binary data of the file)'], { type: 'application/octet-stream' });

axios.post('/api/files/v1/filesets/b8a8878e-7ae6-4ac0-b4dd-fe0e2c9e4dfe/files/multipart/2632e4ba-294b-4c31-85bd-75fa8c608a07/part/1234567890', {
  part: fileData
}, {
  headers: {
...
url = '/api/files/v1/filesets/b8a8878e-7ae6-4ac0-b4dd-fe0e2c9e4dfe/files/multipart/2632e4ba-294b-4c31-85bd-75fa8c608a07/part/1234567890'
...
```bash
curl -X POST '/api/files/v1/filesets/b8a8878e-7ae6-4ac0-b4dd-fe0e2c9e4dfe/files/multipart/2632e4ba-294b-4c31-85bd-75fa8c608a07/part/1234567890' \
     -H 'Content-Type: application/octet-stream' \
     --data-binary '(binary data of the file)'
```
...
fetch('https://api.example.com/api/files/v1/filesets/4f14625a-2e82-45b4-9dab-c8301af8fdb7/files/multipart/5919a4de-4d9a-4288-9875-a97afc6e7a41/finalize', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  }
...
response = requests.post(
    'https://api.example.com/api/files/v1/filesets/4f14625a-2e82-45b4-9dab-c8301af8fdb7/files/multipart/5919a4de-4d9a-4288-9875-a97afc6e7a41/finalize',
    headers={
        'Content-Type': 'application/json'
    }
)
...
curl -X POST 'https://api.example.com/api/files/v1/filesets/4f14625a-2e82-45b4-9dab-c8301af8fdb7/files/multipart/5919a4de-4d9a-4288-9875-a97afc6e7a41/finalize' \
  -H 'Content-Type: application/json'
```
...
- `file`: The assembled file object.
  ...
  - `hash`: SHA-256 hex value of file contents.
  ...
  - `connectorKey`, `indexStatus`, `indexReason`: Metadata related fields.
...
```javascript
const fileSetId = "d65afe63-3e06-46b0-9234-6d5f95c12292";
const fileId = "8d9d8975-e699-402d-9b49-2446a399938b";
...
fileSetId = "d65afe63-3e06-46b0-9234-6d5f95c12292"
fileId = "8d9d8975-e699-402d-9b49-2446a399938b"
...
```bash
curl -X POST "/api/files/v1/filesets/d65afe63-3e06-46b0-9234-6d5f95c12292/files/multipart/8d9d8975-e699-402d-9b49-2446a399938b/abort" \
     -H "Content-Type: application/json"
```
...
```javascript
fetch('https://api.example.com/api/files/v1/filesets/699ae9d3-25ec-41c8-9935-41fbdbea86b9/access', {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json'
  }
...
response = requests.get(
    'https://api.example.com/api/files/v1/filesets/699ae9d3-25ec-41c8-9935-41fbdbea86b9/access',
    headers={'Content-Type': 'application/json'}
)
...
```bash
curl -X GET 'https://api.example.com/api/files/v1/filesets/699ae9d3-25ec-41c8-9935-41fbdbea86b9/access' \
-H 'Content-Type: application/json'
```
...
- `fileSetAccess`: An array of access permissions.
  ...
  - `permission`: The permission level for the FileSet (e.g., OWNER).
...
axios.post('https://example.com/api/files/v1/filesets/c8d304e1-f354-463b-aad5-ce19d27a9d86/access', {
  fileSetAccess: [
    {
      entityId: 42,
      entityType: 'GROUP',
...
url = 'https://example.com/api/files/v1/filesets/c8d304e1-f354-463b-aad5-ce19d27a9d86/access'
headers = {'Content-Type': 'application/json'}
payload = {
    "fileSetAccess": [
        {
...
```bash
curl -X POST https://example.com/api/files/v1/filesets/c8d304e1-f354-463b-aad5-ce19d27a9d86/access \
-H "Content-Type: application/json" \
-d '{
  "fileSetAccess": [
    {
...
- `fileSetId`: The unique identifier of the FileSet.
- `fileSetAccess`: An array of access permissions applied to the FileSet.
  - `entityId`: The identifier for the entity (user or group) assigned permissions.
  - `entityType`: The type of entity ("GROUP" or "USER").
  - `permission`: The permission type assigned ("EDIT", "OWNER", etc.).
...
url = 'http://example.com/api/files/v1/filesets/search'
headers = {'Content-Type': 'application/json'}
data = {
    'fieldSort': [
        {
...
# Use the actual endpoint path
# Include -H headers and -d data as appropriate
curl -X POST http://example.com/api/files/v1/filesets/search \
  -H "Content-Type: application/json" \
  -d '{
    "fieldSort": [
      {
...
const fileSetId = '9a384baf-8c39-49b2-838a-539c75970855';

fetch(`https://api.example.com/api/files/v1/filesets/${fileSetId}/stats`, {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json',
  }
...
fileSetId = '9a384baf-8c39-49b2-838a-539c75970855'

response = requests.get(
    f'https://api.example.com/api/files/v1/filesets/{fileSetId}/stats',
    headers={'Content-Type': 'application/json'}
)
...
```bash
curl -X GET "https://api.example.com/api/files/v1/filesets/9a384baf-8c39-49b2-838a-539c75970855/stats" \
-H "Content-Type: application/json"
```
...
- `otherFileTypeCount`: Number of files that do not fall under the standard categories.
- `notIndexedCount`: Number of files that have not yet been indexed.
...
- `indexSkippedCount`: Number of files that were skipped during indexing.
...
axios.get('http://example.com/api/files/v1/filesets/7a8e46b5-0271-49dd-a4e2-4ccc005a1786/path', {
  params: {
    path: 'example/path/to/resource'
  }
})
...
response = requests.get(
    'http://example.com/api/files/v1/filesets/7a8e46b5-0271-49dd-a4e2-4ccc005a1786/path',
...
```bash
curl -G -X GET "http://example.com/api/files/v1/filesets/7a8e46b5-0271-49dd-a4e2-4ccc005a1786/path" --data-urlencode "path=example/path/to/resource"
```
...
- **hashAlgorithm**: The algorithm used to generate the file hash.
- **downloadUrl**: The URL to download the file (empty if not available).
- **created**: The timestamp when the file was created.
- **createdBy**: The user ID of the creator.
- **connectorKey**: The connector key (if applicable).
...
```javascript
// JavaScript example using fetch to delete a file or directory by path
const fetch = require('node-fetch');
const fileSetId = '3864e667-aa2f-4ce8-8df1-38a8814c3020';
...
```python
# Python example using requests to delete a file or directory by path
import requests

file_set_id = '3864e667-aa2f-4ce8-8df1-38a8814c3020'
path = 'example/path/to/resource'
url = f'https://api.example.com/api/files/v1/filesets/{file_set_id}/path'
...
```bash
# cURL example to delete a file or directory by path
fileSetId='3864e667-aa2f-4ce8-8df1-38a8814c3020'
path='example/path/to/resource'
...
```javascript
const fileSetId = "aef53bf4-af9f-4453-9571-3e58b00fb728";
const filePath = "example/path/to/resource";

fetch(`/api/files/v1/filesets/${fileSetId}/path/download?path=${encodeURIComponent(filePath)}`)
...
fileSetId = "aef53bf4-af9f-4453-9571-3e58b00fb728"
filePath = "example/path/to/resource"

response = requests.get(
    f"/api/files/v1/filesets/{fileSetId}/path/download",
...
curl -L "/api/files/v1/filesets/$fileSetId/path/download?path=$(echo $filePath | sed 's/ /%20/g')" --output downloaded_file
```
...
```javascript
// Example using fetch
const fileSetId = 'b91e94d2-a451-43c7-8efc-47f76ab1b065';
const fileId = '92ed59f7-d29d-4800-9c5c-904cb995a3df';
...
fileSetId = 'b91e94d2-a451-43c7-8efc-47f76ab1b065'
fileId = '92ed59f7-d29d-4800-9c5c-904cb995a3df'
...
```bash
curl -X GET "/api/files/v1/filesets/b91e94d2-a451-43c7-8efc-47f76ab1b065/files/92ed59f7-d29d-4800-9c5c-904cb995a3df" -H "Content-Type: application/json"
```
...
```javascript
fetch('/api/files/v1/filesets/af0359ef-518d-4f67-b648-597477851b1d/files/49aed1ea-916b-4808-9714-a9e6e9074233', {
  method: 'DELETE',
  headers: {
    'Content-Type': 'application/json'
  }
...
url = "/api/files/v1/filesets/af0359ef-518d-4f67-b648-597477851b1d/files/49aed1ea-916b-4808-9714-a9e6e9074233"
headers = {
    "Content-Type": "application/json"
}
...
```bash
curl -X DELETE "/api/files/v1/filesets/af0359ef-518d-4f67-b648-597477851b1d/files/49aed1ea-916b-4808-9714-a9e6e9074233" \
     -H "Content-Type: application/json"
```
...
- Successful response: The response body will be empty, indicating the file or directory was deleted successfully.

### Error Responses

**Response example for error responses**

| Status Code | Description         | Example Body                                                                 |
|-------------|---------------------|------------------------------------------------------------------------------|
| `400`       | Bad Request         | `{ "error": "Invalid file ID specified." }`                                  |
| `403`       | Forbidden           | `{ "error": "You do not have permission to delete this file or directory." }`|
| `409`       | Conflict            | `{ "error": "The file is currently in use." }`                               |
| `413`       | Payload Too Large   | `{ "error": "The request payload is too large." }`                           |

In case of an error, the response will include a JSON object containing an `error` message that describes the issue.
...
```javascript
const fileSetId = "5fed1931-2355-4b3d-9824-b3a8f87130fa";
const fileId = "eecd2f4e-8c4c-486f-af76-e1d1c7c7742b";
...
fileSetId = "5fed1931-2355-4b3d-9824-b3a8f87130fa"
fileId = "eecd2f4e-8c4c-486f-af76-e1d1c7c7742b"

response = requests.get(
    f"https://example.com/api/files/v1/filesets/{fileSetId}/files/{fileId}/download",
    headers={"Content-Type": "application/json"}
)
...
curl -X GET "https://example.com/api/files/v1/filesets/${fileSetId}/files/${fileId}/download" \
    -H "Content-Type: application/json"
```
...
- A successful request will result in a `302 Found` status code, indicating that the file download has been redirected. The `Location` header in the response contains the URL to download the file.
...
| `409`       | Conflict. A conflict occurred processing the request. |
...
const fileSetId = "a63b51ba-0b90-4472-ac2a-fa1b8bc6e91f";
const fileId = "dff61d58-681c-41db-aa3b-30cc46c34524";
const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...";

axios.get(`/api/files/v1/filesets/${fileSetId}/files/${fileId}/content`, {
    headers: {
...
file_set_id = "a63b51ba-0b90-4472-ac2a-fa1b8bc6e91f"
file_id = "dff61d58-681c-41db-aa3b-30cc46c34524"
token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."

response = requests.get(
    f"/api/files/v1/filesets/{file_set_id}/files/{file_id}/content",
    headers={
...
# Use the actual endpoint path
# Include -H headers and -d data as appropriate
curl -X GET "/api/files/v1/filesets/a63b51ba-0b90-4472-ac2a-fa1b8bc6e91f/files/dff61d58-681c-41db-aa3b-30cc46c34524/content" \
